    ...
    const duckBricks = [
      {
        ...
        element_id: 3001,
        color: "#ffcf0b",
        texture: "https://lf-bricks-api.dwarf.dk/storage/textures/eye2.png",
        amount: 4,
      },
      {
        name: "Yellow 1X1 with Eye Main",
        element_id: 3005,
        color: "#ffcf0b",
        texture: "https://lf-bricks-api.dwarf.dk/storage/textures/eye.png",
        amount: 2,
      },
      {
        name: "Red 2X3 Flat",
